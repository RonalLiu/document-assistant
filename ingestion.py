...
def ingest_docs():
    loader = ReadTheDocsLoader(path="docs/langchain-docs/api.python.langchain.com/en/latest", encoding="utf-8")
    ...
    Pinecone.from_documents(documents, embedding, index_name="langchain-doc-index")
